...
export const userResolver = {
    User: {
        posts(obj) {
            return Post.find({userId: obj.id}).catch(error => console.log("error in posts in user data:", error));
        },
        answers(obj) {
            return Answer.find({userId: obj.id}).catch(error => console.log("error in answer in user data:", error));
        }
    },
    Query: {
        userById: (_, {id}) => {
